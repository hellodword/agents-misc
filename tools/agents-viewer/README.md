...
- [`codex-rs/utils/stream-parser/src/proposed_plan.rs`](https://github.com/openai/codex/blob/rust-v0.146.0/codex-rs/utils/stream-parser/src/proposed_plan.rs) for line-level plan extraction semantics;

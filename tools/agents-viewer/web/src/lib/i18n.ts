...
export const resources = {
  en: { translation: {
    ...
    today: "Today", yesterday: "Yesterday", last7: "Last 7 Days", older: "Older", untitled: "Untitled", implementTitle: "Implement · {{title}}", implementPlan: "Implement plan",
  ...
  "zh-CN": { translation: {
    ...
    today: "今天", yesterday: "昨天", last7: "最近 7 天", older: "更早", untitled: "未命名", implementTitle: "执行 · {{title}}", implementPlan: "执行计划",

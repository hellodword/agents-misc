...
export type SearchHit = { session: SessionSummary, entryId: string, kind: EntryKind, snippet: string, matchRanges: Array<MatchRange>, field: SearchField, rank: number, timestamp?: string, };
